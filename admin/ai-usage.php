...
<title>AI Usage — Admin | BharatSEO</title>
...
<div class="app-shell">
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left"><button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle menu" aria-expanded="false"><i data-lucide="menu"></i></button><h1>AI Usage</h1></div>
...
<script>
async function load() {
    const json = await Api.call(appBase() + '/api/admin/ai-usage.php?days=30');
