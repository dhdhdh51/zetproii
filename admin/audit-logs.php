...
<title>Audit Logs — Admin | BharatSEO</title>
...
<div class="app-shell">
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left"><button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle menu" aria-expanded="false"><i data-lucide="menu"></i></button><h1>Audit Logs</h1></div>
...
async function load(page = 1) {
    const json = await Api.call(appBase() + '/api/admin/audit-logs.php?page=' + page);
