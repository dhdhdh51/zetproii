...
<div class="app-shell">
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left"><button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle menu" aria-expanded="false"><i data-lucide="menu"></i></button><h1>Businesses</h1></div>
        ...
        <div class="page-body">
            <div class="card" style="margin-bottom:16px;display:flex;gap:10px;flex-wrap:wrap;">
                <input id="f-search" class="form-control" placeholder="Search business name..." style="max-width:260px;" aria-label="Search business name">
