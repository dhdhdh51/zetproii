        ...
        <div class="page-body">
            ...
            <div class="tab-panel" id="tab-seo">
                ...
                <div class="card">
                    ...
                    <div id="seo-content-list"><p style="color:var(--color-text-muted);font-size:14px;">Select a project to view generated content.</p></div>
                </div>
            </div>
        </div>
    </div>
...
async function loadSeoContentForProject(projectId) {
    ...
    list.innerHTML = json.data.map(c => `
        <div class="card" style="margin-bottom:10px;">
            ...
            <p style="font-size:13px;color:var(--color-text-muted);margin:0 0 8px;">${c.meta_description || ''}</p>
