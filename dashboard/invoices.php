...
<title>Invoices — BharatSEO</title>
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            <div class="card" style="margin-bottom:16px;display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;">
                <input id="f-search" class="form-control" placeholder="Search invoices..." style="max-width:240px;" aria-label="Search invoices">
...
<div class="modal-overlay" id="manual-modal">
    <div class="modal-box" style="max-width:680px;">
        ...
        <form id="manual-form">
            ...
            <div class="form-group"><label for="m-due">Due Date</label><input id="m-due" type="date" class="form-control"></div>
...
<div class="modal-overlay" id="payment-modal">
    <div class="modal-box">
        ...
        <div class="form-group"><label for="payment-amount">Amount</label><input id="payment-amount" type="number" class="form-control"></div>
        <div style="display:flex;gap:10px;">
...
async function load(page = 1) {
    ...
    const json = await Api.call(appBase() + '/api/business/invoices.php?' + params.toString());
...
document.getElementById('manual-form').addEventListener('submit', async (e) => {
    ...
    const json = await Api.call(appBase() + '/api/business/invoices.php', { method: 'POST', body: { business_id: businessId, items, due_date: document.getElementById('m-due').value } });
...
document.getElementById('payment-submit').addEventListener('click', async () => {
    ...
    const json = await Api.call(appBase() + '/api/business/invoice-payment.php', { method: 'POST', body: { business_id: businessId, invoice_id: invoiceId, amount } });
